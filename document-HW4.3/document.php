...
<body style="background-color:#FFFBE9">
    ...
    <h1 align =right >คำสั่งแต่งตั้ง &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
    ...
    <a href='selectdocument.php'><span class='glyphicon glyphicon-search' style='color:#00B4D8;'></span></a></h2>
        ...
        if ($result->num_rows == 0) {
            ...
            while($row = $result->fetch_object()){ 
                ...
                $table.= "<td>";
                $table.= "<a style='color:#548CFF;' href='editdocument.php?id=$row->id'>&emsp;&emsp;&emsp;&emsp;&emsp;<span class='glyphicon glyphicon-pencil' aria-hidden='true'></span></a>";
                $table.= " | ";
                ...
                $table.= "</td>";
                $table.= "<td>";
                $table.= "<a style='color:#548CFF;' href='addstafftodocument.php?id=$row->id'>&emsp;&emsp;&emsp;&emsp;<span class='glyphicon glyphicon-user' aria-hidden='true' ></span></a>";
                $table.= "</td>";
                $table.= "</tr>";
            }
